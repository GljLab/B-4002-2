...
.stat-card-posts :deep(.el-statistic__number) {
  color: #2d6df6;
}

.stat-card-pending :deep(.el-statistic__number) {
  color: #eab308;
}

.stat-card-authors :deep(.el-statistic__number) {
  color: #16a34a;
}

.stat-card-monthly :deep(.el-statistic__number) {
  color: #f97316;
}
